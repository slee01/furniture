...
def main():
    ...
    for j in range(num_updates):
        ...
        for step in range(args.num_steps):
            with torch.no_grad():
                if args.hierarchical_policy and args.task_transition:
                    task, task_features = trans.act(  # task_trans_model.TaskTransitionModel
                        rollouts.obs[step],
                        prev_task,
                        mean_mode=False,
        ...
        post_rewards = copy.deepcopy(rollouts.rewards.vi)
        ...
        if args.task_transition:
            if args.task_curiousity_reward:
                for step in range(args.num_steps):
        ...
        if args.eval_interval is not None and j % args.eval_interval == 0:
            ...
            if args.hierarchical_policy:
                ...
                _episode_rewards = evaluate(
                    ...
                    ob_rms, args.env_name, args.seed, args.num_prossess, eval_log_dir, device
                )
