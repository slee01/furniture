...
parser.add_argument('--env-name', default='MountainToyCarContinuous-v1',
...
def millions(x, pos):
    ...
    return '%1.2fM' % (x*1e-6)
    # return '%1.1fM' % (x*1e-6) # FOR MOUNTAINTOYCAR
...
# formatter = FuncFormatter(thousands) # FOR MOUNTAINTOYCAR
